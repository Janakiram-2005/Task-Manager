            ...
            <div className="flex items-start justify-between gap-2">
                <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                        ...
                        {request.section && (
                            <span className="ml-2 rounded-full bg-indigo-100 px-2 py-0.5 text-[10px] font-bold text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300">
                                §{ROMAN[request.section - 1]}
                            </span>
                        )}
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="rounded-lg border border-red-300 bg-white px-3 py-1 text-xs font-semibold text-red-600 transition hover:bg-red-50 dark:border-red-700 dark:bg-slate-900 dark:text-red-400 dark:hover:bg-red-950/40"
                    >
                        ✕ Reject
                    </button>
                    <button
